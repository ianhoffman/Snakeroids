...
class Game {
    ...
    createInitialView() {
        ...
        //     x: this.spaceShip.center.x,
        //     y: this.spaceShip.center.y
        // }));
    }
        ...
        for(let i = 0; i < this.asteroids.length; i++ ) {
            ...
            if(this.spaceShip) {
                if(this.spaceShip.isCollidedWith(currAsteroid)) {
                    this.handleCollision(this.spaceShip, currAsteroid);
                }
            }
            ...
            for(let k = 0; k < this.bullets.length; k++ ) {
                if(currAsteroid.isCollidedWith(this.bullets[k])) {
                    this.handleCollision(currAsteroid, this.bullets[k], i);
                }
            }
        }
