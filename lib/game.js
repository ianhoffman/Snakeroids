...
class Game {
    ...
    createInitialView() {
        ...
        //     x: this.spaceShip.pos.x + 40,
        //     y: this.spaceShip.pos.y + 45
        // }));
    }
    ...
    getCollisions() {
        for(let i = 0; i < this.asteroids.length; i++ ) {
            ...
            if(this.spaceShip && currAsteroid.isCollidedWith(this.spaceShip)) {
                this.handleCollision(currAsteroid, this.spaceShip);
    ...
    handleCollision(obj1, obj2) {
        if(this.spaceShip) {
            if(obj1.type === 'spaceship' && obj2.type === 'asteroid' || 
                obj2.type === 'spaceship' && obj1.type === 'asteroid') {
                this.explosions.push(new Explosion({
                    x: this.spaceShip.pos.x,
                    y: this.spaceShip.pos.y
                }));
                this.spaceShip = null;
            }
        }
